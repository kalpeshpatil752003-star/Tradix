            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div className="mx-auto max-w-screen-sm text-center">
                    ...
                    <Link
                        ...
                        className="inline-flex text-white bg-red hover:bg-gray-50 hover:text-black focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center my-4">Back to {isAuthenticated ? 'dashboard' : 'Home'}</Link>
                </div>
            </div>
        </section>
    )
