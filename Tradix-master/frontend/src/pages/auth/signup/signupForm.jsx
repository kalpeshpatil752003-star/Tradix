        ...
        <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
            <div>
                <InputField
                    ...
                    onBlur={handleBlur}
                    errorMsg={errors.UserName && touched.UserName && errors.UserName}
                />
            </div>
            ...
            <div className="flex items-start">
                ...
                <div className="ml-2 text-sm">
                    <label htmlFor="terms" className="font-light text-gray-500 dark:text-gray-300">
                        I accept the{" "}
                        <a className="font-medium text-primary-100 hover:underline dark:text-brand-100" href="/terms-of-service">
            ...
            <Button type="submit" id="create-account" disabled={isSubmitting}>
                Create an account
            </Button>
