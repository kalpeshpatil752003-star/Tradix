...
export const Button = forwardRef(({ className, ...props }, ref) => (
    ...
    <button
        className="w-full px-5 py-2.5 text-sm sm:text-base font-medium text-center text-black bg-white rounded-lg hover:bg-white/70"
        ref={ref}
        {...props}></button>
...
export const SubmitButton = forwardRef(({ className, ...props }, ref) => (
    ...
    <button
        type="submit"
        className="inline-flex items-center px-5 py-2 text-sm font-medium text-center text-black bg-white rounded-lg hover:bg-white/70"
        ref={ref}
        {...props}></button>
